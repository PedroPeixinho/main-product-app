...
export default function RegisterScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      <Text style={styles.infoTextAcess}>Você utilizará esse e-mail para entrar</Text>
      ...
      <Text style={styles.infoTextAcess}>Sua senha deve conter no mínimo 6 dígitos</Text>
